            ...
            <div class="col-12">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('/laporan/tambah')?>" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="offset-xl-2  col-12 col-sm col-xl-4">  
                                    <div class="form-group">
                                        ...
                                        <input name="judul" type="text" class="form-control <?= ($data['validation']->hasError('judul')) ? 'text-danger border border-danger' : 'text-primary border border-primary' ?>" placeholder="..."> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="keterangan"
                                                class="form-control <?= ($data['validation']->hasError('keterangan')) ? 'text-danger border border-danger' : 'text-primary border border-primary' ?>"></textarea> 
                                        <small class="text-danger  ">  
